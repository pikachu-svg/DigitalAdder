...
function Khalf() {
  return (
    <div className="mt-5">
      <table className="table-fixed border-3 border-collapse w-3/5 mx-auto">
        <thead>
      ...
      <h1 className="w-3/5 mx-auto justify-center items-center flex mt-3.5 text-1xl ">Highlighted cells represent minterms where Sum = 1</h1>   
      <div className="mt-5">
      <table className="table-fixed border-3 border-collapse w-3/5 mx-auto">
        <thead>
          <tr className="bg-gray-200">
      ...
      <h1 className="w-full text-center mt-3.5 text-1xl ">Carry = AB</h1>
      <h1 className="w-3/5 mx-auto justify-center items-center flex mt-3.5 text-1xl ">Carry is generated only when both inputs are 1</h1> 
      </div>
    </div>
  );
}

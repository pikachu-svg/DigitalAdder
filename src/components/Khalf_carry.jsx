...
function Khalf_carry() {
  return (
    <div className="mt-5">
      ...
      <h1 className="w-4/5 mx-auto justify-center items-center flex mt-3.5 text-1xl ">Carry is generated only when both inputs are 1</h1> 
      </div>
  )
}

export default Khalf_carry

    ...
    <div className='mt-5'>
        <table className='table-fixed border-collapse border-3 w-5/6 mx-auto items-center justify-center'>
            ...
            <tr>
                ...
                <td className='border-2 border-black py-2.5 text-center'>0</td>
                <td className='border-2 border-black py-2.5 text-center'><span className='bg-yellow-200 border-2 border-black px-3.5 py-1.5'>1</span></td>
                <td className='border-2 border-black py-2.5 text-center'>0</td>
            </tr>
            <tr>
                ...
                <td className='border-2 border-black py-2.5 text-center'><span className='border-2 border-black bg-yellow-200 px-3.5 py-1.5'>1</span></td>
                <td className='border-2 border-black py-2.5 text-center'><span className='border-2 border-black bg-yellow-200 px-3.5 py-1.5'>1</span>
                </td>
            </tr>
            </tbody>
        </table>
